...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width': '80', 'padding': '3px', 'font-size': '20px', 'textAlignlist':'center'})
    ]),
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= recession_data.groupby('Vehicle_Type').reset_index()
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec, values='exp_percent', names= 'Vehicle_Type', title='Recessionary Expenditure Percentage by Vehicle Type')
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec= recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        R_chart4= dcc.Graph(
            figure=px.bar(unemp_rec, x='Automobile_Sales', y= 'unemployment_rate',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        yas= data.groupby('Year')['Automobile_Sales'].reset_index()
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales',
        title='Yearly Automobile Sales'))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        mas= data.groupby('Month')['Automobile_Sales'].reset_index()
        Y_chart2 = dcc.Graph(mas, x='Month', y='Automobile_Sales',
